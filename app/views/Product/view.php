...
<div class="container py-3">
    <div class="row">
        <div class="col-md-5 order-md-2">
            <h1 class="popupCatalogTitle"><?= $product['title'] ?></h1>

            <ul class="list-unstyled">
                    <li><i class="fas fa-check text-success me-3"></i> <?php __('product_view_in_stock'); ?></li>
                    <li><i class="fas fa-shipping-fast text-muted me-3"></i> <?php __('product_view_expected'); ?></li>
